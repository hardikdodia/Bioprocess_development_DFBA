...
misc = input("Enter the number of absolte metabolites with relative concentration: ");
...
Std_Curve_Data1 = readtable(excelfilename,'Sheet','Std Curve_culture','VariableNamingRule','preserve');
Std_Curve_Data2 = readtable(excelfilename,'Sheet','Std Curve_NCC','VariableNamingRule','preserve');
